...
class RolesAndPermissionsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $ass_secretary = Role::create(['name' => 'assistant secretary']);
        $treasurer = Role::create(['name' => 'treasurer']);
        $accountant = Role::create(['name' => 'accountant']);
        $fin_sec = Role::create(['name' => 'financial secretary']);
        $ass_fin_sec = Role::create(['name' => 'assistant financial secretary']);
        $president = Role::create(['name' => 'president']);
        $coop_staff = Role::create(['name' => 'cooperative member']);
        ...
        $secretary->givePermissionTo([$create_member, $read_member, $update_member, $disable_member, $view_member_dashboard, $view_member_ledger, $create_centre, $read_centre, $update_centre, $delete_centre, $create_bank, $read_bank, $update_bank, $delete_bank, $generate_reports]);

        $ass_secretary->givePermissionTo([$create_member, $read_member, $update_member, $disable_member, $view_member_dashboard, $view_member_ledger, $create_centre, $read_centre, $update_centre, $delete_centre, $create_bank, $read_bank, $update_bank, $delete_bank, $generate_reports]);
