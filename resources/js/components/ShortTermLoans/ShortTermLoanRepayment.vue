...
export default {
  ...
  methods: {
    submitForm: function() {
      ...
      axios
        .post(`members/short-term-loan-repayment/${this.member.ippis}`, this.repayment)
        .then(res => {
          ...
          var baseUrl =
            ...
            window.location.href = baseUrl + `members/${this.member.ippis}/short-term`;
        })
        .catch(e => {
          // console.log(e);
  ...
  created() {
    ...
    axios
      .get(`members/short-term-loan-repayment/${this.member.ippis}`, this.loan)
      .then(res => {
        // console.log(res.data);
