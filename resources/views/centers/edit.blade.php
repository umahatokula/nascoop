    ...
    <div class="col-12">
        <div class="card m-b-30">
            ...
            {!! Form::model($center, ['route' => ['centers.update', $center->id], 'method' => 'PUT']) !!}
                ...
                <div class="form-group row"><label for="transacting_bank_ledger_no" class="col-sm-2 col-form-label">Bank Account Code</label>
                    <div class="col-sm-10">
                        {!! Form::number('transacting_bank_ledger_no', null, ['class' => 'form-control', 'id' => 'code']) !!}
                    </div>
                </div>
