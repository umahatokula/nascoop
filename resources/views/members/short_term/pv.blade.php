    ...
    <div class="col-md-8">
        <div class="card m-b-30">
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-6">
                        <a href="{{ route('members.shortTermLoansPaymentVoucherPDF', $loan->id) }}"
                            class="btn btn-primary waves-effect waves-light mb-1"><i class="mdi  mdi-file-pdf-box"></i>
                            PDF</a>
                    </div>
                            ...
                            <table class="table table-bordered mt-4">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <th>{{$loan->member->member_pay_point? $loan->member->member_pay_point->name : ''}}
                                        </th>
                                    </tr>
                                </tbody>
                            </table>
                            <table class="table table-bordered mt-5">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>Payments of <b>&#8358; {{ number_format($loan->total_amount, 2) }}</b> to
                                            the
                                            above named being Loan granted to enable him/her meet up with personal needs
                                            which is to be paid in {{ $loan->no_of_months }} months</td>
